...
<div class="row">
	...
	?>
		<div class="alert alert-success">
			Operación realizada correctamente. <a class="btn btn-primary btn-sm" href="index.php?controller=note&action=list">Volver al listado</a>
		</div>
	<?php
	}
	?>
	<form class="form" action="index.php?controller=note&action=save" method="POST">
		...
		<a class="btn btn-sm btn-outline-danger" href="index.php?controller=note&action=list">Cancelar</a>
	</form>
</div>